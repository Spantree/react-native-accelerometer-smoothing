## Spring-based accelerometer smoothing

Accelerometer smoothing is usually done via high pass filters, low pass
filters, moving averages, etc. For simply using accelerometer data to
drive View transformations, like the iOS icons and background shifting
slightly when you tilt the phone, it's possible to use the `Animated`
API for a nice effect.


## CRNA boilerplate readme below
